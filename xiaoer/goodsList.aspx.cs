...
public partial class goodsList : System.Web.UI.Page
{
    ...
    /// 如果Request["var"]的值为1，表示点击头控件中的“新品上市”、“特价商品”和“热销商品”导航到该浏览页
    ...
    public void dlBind()
    {
        ...
        {
            dlBindPage(Convert.ToInt32(Request["id"].ToString()), 0);//分页显示新上市商品/特价商品/热销商品
    ...
    public void deplayTitle()
    {
        if (this.Request["var"] == "1")
        {
            ...
            { 
                case "1":
                    this.labTitle.Text="首页/新品上市";
                    break;
                case "2":
                    this.labTitle.Text = "首页/精品推荐";
                    break;
                case "3":
                    this.labTitle.Text = "首页/特价商品";
                    break;
                case "4":
                    this.labTitle.Text = "首页/热销商品";
                    break;
            }
