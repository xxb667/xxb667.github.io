...
public partial class userManage_Register : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (this.txtPostCode.Text.Trim() != "" || this.txtPhone.Text.Trim() != "" || this.txtEmail.Text.Trim() != "" || this.txtAddress.Text.Trim() != "" || this.txtName.Text.Trim() != "" || this.txtPassword.Text.Trim() != "" || this.txtTrueName.Text.Trim() != "")
        {
            ...
            {
                Response.Write(ccObj.MessageBox("恭喜您，注册成功！", "SellLogin.aspx"));
            }
            else
            {
