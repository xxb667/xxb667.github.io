<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageLogin.aspx.cs" Inherits="Manage_Login" %>
...
<body style="text-align: left;">
    ...
    <div style="width:310px; height:334px; background-image: url('../images/login.jpg');background-attachment:fixed;"  align =center >
    <br />
        <br />
        <br />
    <br />
    <br />
    <table style="width: 280px; height:86px; font-size: 9pt;" border="0" cellpadding="0" cellspacing="0" align="left" >
            ...
            <tr style="color: #000000" valign =top >
                ...
                <td style="width: 51px" valign =top >
                    &nbsp; 
                    <asp:Label ID="labCode" runat="server"  BackColor="Silver">8888</asp:Label></td>
            </tr>
            <tr>
