<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="userManage_Register" %>
				...
				<tr>
					...
					<br />
						<table  id="tabAddMenber"  runat = "server" style ="font-size :9pt">
							...
							<tr>
								<td align="right" style="height: 24px; width: 149px;font-size :9pt">密 码：
								</td>
                            ...
                            <tr>
                                ...
                                <td style="height: 24px" align="left">
                                    ...
                                    <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail"
                                        ...
                                        Width="132px">您输入的E-mail地址格式不正确</asp:RegularExpressionValidator></td>
                            </tr>
                            <tr>
								<td align="right" style="width: 149px;font-size :9pt">
                                    详细住址：
