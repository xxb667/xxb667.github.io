...
CREATE DATABASE [db_NetStore]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'db_NetStore', FILENAME = N'D:\db_NetStore.mdf' , SIZE = 9216KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'db_NetStore_log', FILENAME = N'D:\db_NetStore_log.ldf' , SIZE = 3456KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
