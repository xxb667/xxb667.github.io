...
public partial class Manger_ProductAdd : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        string strSql="select * from tb_BookInfo1 where BookName='"+strBookName+"'and Author='"+strAuthor+"'and Company='"+strCompany+"'";
        ...
        {//将商品信息插入数据库中
            string strAddSql = "Insert into tb_BookInfo1(ClassID,BookName,BookIntroduce,Author,Company,BookUrl,MarketPrice,HotPrice,Isrefinement,IsHot,IsDiscount)";
